...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    Page<Post> findByCategoryAndTitleContainingIgnoreCaseOrCategoryAndContentContainingIgnoreCase(String category1, String title, String category2, String content, Pageable pageable);
